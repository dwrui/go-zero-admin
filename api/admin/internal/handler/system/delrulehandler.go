...
func DelRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelRuleReq
		//解析参数
		...
		//验证参数
		if msg := validate.DelRuleValidate(req); msg != "" {
			httpx.WriteJsonCtx(r.Context(), w, http.StatusOK, ga.Failed().SetMsg(msg))
			return
		}
		l := system.NewDelRuleLogic(r.Context(), svcCtx)
		_, err := l.DelRule(&req)
		if err != nil {
