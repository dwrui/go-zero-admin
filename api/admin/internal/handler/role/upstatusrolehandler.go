...
func UpStatusRoleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpStatusRoleReq
		var err error
		//解析参数
		...
		//验证参数
		if msg := validate.UpStatusRoleValidate(req); msg != "" {
			httpx.WriteJsonCtx(r.Context(), w, http.StatusOK, ga.Failed().SetMsg(msg))
			return
		}

		l := role.NewUpStatusRoleLogic(r.Context(), svcCtx)
		_, err = l.UpStatusRole(&req)
		if err != nil {
