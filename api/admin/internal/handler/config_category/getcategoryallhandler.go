...
func GetCategoryAllHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		l := config_category.NewGetCategoryAllLogic(r.Context(), svcCtx)
		resp, err := l.GetCategoryAll()
		if err != nil {
