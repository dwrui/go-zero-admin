...
const file_auths_proto_rawDesc = "" +
	...
	"\tnew_token\x18\x02 \x01(\tR\bnewToken2\xdf\x01\n" +
	"\vAuthService\x12?\n" +
	"\n" +
	...
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB\bZ\x06./authb\x06proto3"
...
var file_auths_proto_depIdxs = []int32{
	...
	4, // 1: auth.AuthService.RefreshToken:input_type -> auth.RefreshTokenRequest
	...
	5, // 4: auth.AuthService.RefreshToken:output_type -> auth.RefreshTokenResponse
